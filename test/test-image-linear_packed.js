...
describe(`Extra tests for util/image-packed`, function() {
	...
	runTest(
		`should handle 2bpp padded rows (14x2)`,
		{
			packed: [
				0x66, 0x66, 0x66, 0x60,
				0x99, 0x99, 0x99, 0x90,
			...
			linear: [
				0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02,
	...
	runTest(
		`should handle 2bpp padded rows (9x2)`,
		{
			packed: [
				0x66, 0x66, 0x40,
				0xDD, 0xDD, 0xC0,
	...
	runTest(
		`should handle 2bpp padded rows (10x2)`,
		{
			packed: [
				0x66, 0x66, 0x60,
				0xDD, 0xDD, 0xD0,
	...
	runTest(
		`should handle 2bpp padded rows (11x2)`,
		{
			packed: [
				0x66, 0x66, 0x64,
				0xDD, 0xDD, 0xDC,
	...
	runTest(
		`should handle 2bpp padded rows (17x2)`,
		{
			packed: [
			...
			linear: [
				0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01, 0x02, 0x01,
	...
	runTest(
		`should handle 2bpp padded rows (19x4)`,
		{
			packed: [
